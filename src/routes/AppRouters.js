  ...
  return(
    ...
    <Route path="products" element={<Outlet />}>
      <Route index element={<ProductList bloc={() => ProductListBloc(UseProductList, ProductService, RouteNavigation)}/>}/>
       <Route path="form" element={<ProductForm bloc={() => ProductFormBloc(ProductService, RouteNavigation)} />}/>
       <Route path="form/:id" element={<ProductForm bloc={() => ProductFormBloc(ProductService, RouteNavigation)} />}/>
      </Route>
